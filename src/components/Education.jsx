      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col border-l-2 border-gray-400 pl-8 space-y-10">
            {/* Box 1 */}
            <div
              className="relative bg-[#232526] rounded-xl p-6 shadow-md transition hover:shadow-xl"
              data-aos="fade-right"
            >
          ...
          <div
            className="hidden md:flex items-center justify-center bg-[#232526] rounded-xl p-6 shadow-md"
            data-aos="zoom-in"
          >
            <img
              src={edu}
