<section
  id="home"
  className="flex flex-col md:flex-row items-center justify-center min-h-screen px-6 py-0 bg-gradient-to-b from-[#161513] to-[#232526] text-center md:text-left gap-0 md:gap-12"
>
  {/* Right Section - Image */}
  <div className="flex justify-center order-1 md:order-2 -mt-6 md:-mt-12"> {/* Pull image up */}
    <img
      src={Picture}
      alt="Ravichandra"
  ...
  <div className="mt-4 flex flex-col items-center md:items-start md:flex-1 order-2 md:order-1 md:ml-28">
